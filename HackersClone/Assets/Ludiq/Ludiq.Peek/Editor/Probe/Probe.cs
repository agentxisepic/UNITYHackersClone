...
namespace Ludiq.Peek
{
	...
	public static class Probe
	{
		...
		private static void SetupHighlight()
		{
			...
			highlightEffectMaterial.SetColor("_Color", ((Color)UnityEditorDynamic.SceneView.kSceneViewSelectedOutline.Color).WithAlpha(0.5f));
			highlightEffectMaterial.SetColor("_ChildColor", ((Color)UnityEditorDynamic.SceneView.kSceneViewSelectedChildrenOutline.Color).WithAlpha(0.5f));
		}
