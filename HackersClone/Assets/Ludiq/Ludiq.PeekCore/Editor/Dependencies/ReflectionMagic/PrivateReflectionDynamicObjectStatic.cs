...
namespace Ludiq.PeekCore.ReflectionMagic
{
    ...
    {
        private static readonly ConcurrentDictionary<Type, IDictionary<string, IDynamicAccessor>> _propertiesOnType = new ConcurrentDictionary<Type, IDictionary<string, IDynamicAccessor>>();
        ...
        protected override IDictionary<Type, IDictionary<string, IDynamicAccessor>> PropertiesOnType => _propertiesOnType;
